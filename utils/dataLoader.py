...
class DataLoader:
	...
	def next(self):
		...
		# correct answer
		a = np.zeros((cur_batch_size, ), dtype='int32')	
		# num
		...
		for n, ix in enumerate(idxs):
			paragraph_indices, question_indices, ans_indices, candidate_indices, \
				paragraph_chars, question_chars, cloze, num, ans, candidate = self.samples[ix]
			ans_all.append(ans)
		...
		self.iter += 1
		return dw, dt, qw, qt, a, m_dw, m_qw, tt, tm, c, m_c, cl, str(nums), ans_all, candidate_all
